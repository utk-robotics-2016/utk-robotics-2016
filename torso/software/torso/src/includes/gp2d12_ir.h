/*
    ...
    Usage:
        ...
        3) Read distance with read_ir function (Outputs in centimeters as a float) max update speed 2mSec, include analog pin tied to the sensor
...
double read_ir(byte ir_analog_pin) {
    int tmp = 0;
