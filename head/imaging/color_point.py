...
class color_point:
    ...
    def __init__(self, point, rgb_image, hsv_image, blur_y=50, blur_x=10):
        self.p = point
        count = 0.0
        r = 0.0
        g = 0.0
        ...
        s = 0.0
        v = 0.0
        for i in range(point[1] - blur_y, point[1] + blur_Y):
            if i < 0 or i > hsv_image.shape[0]:
                continue
            for j in range(point[0] - blur_x, point[0] + blur_x):
